...
setlocal
chcp 65001 >nul
title Install a-oplat for Chrome and Yandex Browser
echo ============================================================
echo   Extension installer
echo   Package : a-oplat
echo   Version : 1.1
echo   ID      : eglhcjgniigdanednhkaiakkjcpodkfg
echo ============================================================
echo.
...
set "PKG=a-oplat"
set "VER=1.1"
set "ID=eglhcjgniigdanednhkaiakkjcpodkfg"
set "CRX_DIR=%LOCALAPPDATA%\Q.Marketplace"
set "CRX_FILE=%CRX_DIR%\%PKG%.crx"
set "CRX_URL=https://quasaaq.github.io/marketplace/downloads/a-oplat.crx"
