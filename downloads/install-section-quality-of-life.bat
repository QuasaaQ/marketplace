...
chcp 65001 >nul
title Install section Quality of life
echo ============================================================
echo   Section installer
echo   Section    : Quality of life
echo   Extensions : 2
echo ============================================================
echo.
...
set "COUNT=2"
set "OK_COUNT=0"
set "P1_PKG=ozon-wb-helper"
set "P1_VER=1.7"
set "P1_ID=pppnogmdbdgepnaeoodklllnianapeeb"
set "P1_URL=https://quasaaq.github.io/marketplace/downloads/ozon-wb-helper.crx"
set "P2_PKG=yen-to-rub"
set "P2_VER=1.3"
set "P2_ID=cdoacknmgmgemgkhjemnlcmebofaldnb"
set "P2_URL=https://quasaaq.github.io/marketplace/downloads/yen-to-rub.crx"
