...
setlocal
chcp 65001 >nul
title Install a-motivac-grey for Chrome and Yandex Browser
echo ============================================================
echo   Extension installer
echo   Package : a-motivac-grey
echo   Version : 1.2
echo   ID      : ckmfnfafacifdnkhijaidbbknlneogdj
echo ============================================================
echo.
...
set "PKG=a-motivac-grey"
set "VER=1.2"
set "ID=ckmfnfafacifdnkhijaidbbknlneogdj"
set "CRX_DIR=%LOCALAPPDATA%\Q.Marketplace"
set "CRX_FILE=%CRX_DIR%\%PKG%.crx"
set "CRX_URL=https://quasaaq.github.io/marketplace/downloads/a-motivac-grey.crx"
